...

{
  ...
  MailCommand = "bsmtp -h localhost -f \"root@${config.networking.hostName}\" -s \"Bacula—%l %t of %c %e\" %r"
  OperatorCommand = "bsmtp -h localhost -f \"root@${config.networking.hostName}\" -s \"Bacula—Intervation needed for %j\" %r"
